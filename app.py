...
def _extract_kg_with_domain(text: str, _dc=None, _claude=None, _kg=None):
    ...
    스레드 안전을 위해 dc/claude/kg를 직접 전달받습니다.
    """
...
def _process_file_contents(entries: list) -> int:
    ...
    if kg_targets:
        ...
        with ThreadPoolExecutor(max_workers=3) as executor:
            futures = {
                executor.submit(_extract_kg_with_domain, st.session_state.documents[fname], _captured_dc, _captured_claude, _captured_kg): fname
